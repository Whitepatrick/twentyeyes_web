...
%p
  It's been quite a long time since I've been able to update this page and a lot has happened since! Lianna and I are all moved in and have settled our aparment nicely. Finally getting into the swing of a significantly different commute. I don't miss the 16th bus in DC, but comparitively the commute in DC was far more chill than NYC as NYC has no chill.
%p
  I've been coding a lot lately and have got a few little pet projects going.
%p
  First up is
  %a{:href => "https://github.com/Whitepatrick/20eyesbot", :target => "_blank"} a twitter bot
  designed to basically follow anyone who matches a very low set of criteria. This was mostly an excercise to checkout the twitter API and occupy a weekend or two. It has a few unit tests and a functional test as well. I'm still toying with the idea of completely redoing it.
%p
  Next is *another* bot meant to idle in a channel I sometimes idle in on irc.freenode.net called #gnudism.
  %a{:href => "https://github.com/Whitepatrick/gnudism_bot", :target => "_blank"} This bot
  also doesn't do an incredible lot. It's got an autovoice feature that I'm trying to work into an auto-op feature, but setting up proper authorization is tricky since I want to get auto op'ed no matter where I'm signed in from.
%p
  One of the bigger undertakings is revamping this site *again* to include
  %a{:href =>"https://github.com/Whitepatrick/twentyeyes_api", :target => "_blank"} an API with a PostgreSQL backend
  Nothing crazy at all, session handling and simple CRUD operations. I've got a few unit tests in there as well.
%hr
%h1
  PAST:
%h3
  July 28th: NEW SITE IS GO!
  %img{:src => "images/congrat.gif", :style => "float: right; margin: 0px 0px 15px 15px;"}/
%p
  Finally, the navigation bar is working as it should on the sinatra / ruby / haml
  version of this site and I'm ready to retire the old one. I'm moving to NYC
  at the end of this week and welcome this fix amid being SO stressed out. But
  the end is approaching and I can't wait to be settled in and start my new
  adventure in New York.
%hr
%h3
  July 19th: navbar.. more like navBORING amirite?!
%p
...
%hr
%h3
  3/29/2015: Jenkins & I.. RUNITED!
  %img{:src => "images/jenkins_patrick.png", :style => "float: right; margin: 0px 0px 15px 15px;"}/
%p
  One of my favorite developers left the company I work to persue a new job, good for him!
  He was one of the few people left who were passionate about changing the course of our
  tech team from relying on manual testing, and was supporting almost all of the test
  infrastructure on his own. I won't go in to great deal of said "test infrastructure" since
  it's not that much to speak of, but the most glaring issue was that no one would be supporting
  %a{:href => "https://www.atlassian.com/software/bamboo", :target => "_blank"} Bamboo
  with him leaving. I have worked with Bamboo a little bit before but I was always turned off
  by their shifty community of plugins (don't get me started), plus the license was about to
  expire for our Bamboo install. How fortuitous! I have been using
